...
public class HangfireRecurringJobs : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        Hangfire.RecurringJob.AddOrUpdate<UserService>(nameof(UserService.SyncUsers), s => s.SyncUsers(null, CancellationToken.None), "0 * * * *");
        ...
        Hangfire.RecurringJob.TriggerJob(nameof(UserService.SyncUsers));
